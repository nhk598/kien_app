...
export default function NewsFeedUser() {
    ...
    return (
        ...
        <div className="binhLuan d-flex-column fa-border">
            ...
            <div className="row col-xl-10 col-lg-10 col-md-10 col-sm-10 mx-auto">
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ratione quibusdam error culpa vitae, numquam commodi eveniet laudantium voluptas, natus ab cum aspernatur officiis nobis, quod ut fuga asperiores. Neque,
                accusantium?
                </p>
                {/* bigin img news */}
                ...
                <div className="col-10 ml-auto">
                    ...
                    <div className="card card-body">
                        ...
                        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nobis nam cumque dolorem facere, hic fugit, magni similique labore ipsa unde placeat, mollitia quam aspernatur nihil ab architecto! Autem,
                        facere nihil?</p>
                        {/* end text commented */}
